...
SPOTIFY_CLIENT_ID = getenv("SPOTIFY_CLIENT_ID", "36e6dbc137e94481b5730491a79307cd")
SPOTIFY_CLIENT_SECRET = getenv("SPOTIFY_CLIENT_SECRET", "e6cf521a77f94d69b604d1f679790104")
